                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center w-75 m-auto">
                                <a href="">
                                    <span> <img src="<?php echo base_url('public') ?>/assets/images/logo-light.jpg" alt="" height="50"></span>
                                </a>
                            ...
                            <form action="<?= base_url('auth'); ?>" method="post">
                                ...
                                <div class="form-group mb-0 text-center">
                                    <!-- <a href="<?= base_url('dashboard') ?>"><button class="btn btn-primary btn-block" type="button">
                                            Log In </button></a> -->

                                <button type="submit" class="btn btn-primary btn-block" type="button"> Log In </button>
                                </div>
