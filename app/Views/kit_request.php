...
<div class="content">
                                                    ...
                                                    <div>
                                                        <div id="tabs-1" role="tabpanel">
                                                            ...
                                                            <div class="col-md-12 mb-3">
                                                                ...
                                                                <a href="<?= base_url('appointment-details') ?>"> <button class="btn btn-sm btn-outline-primary mr-2">09:00
                                                                am</button></a>
                                                                <a href="<?= base_url('appointment-details') ?>"> <button class="btn btn-sm btn-outline-primary mr-2">10:00
                                                                am</button></a>
                                                                <a href="<?= base_url('appointment-details') ?>"><button class="btn btn-sm btn-outline-primary mr-2">11:00
                                                                am</button></a>
                                                                <a href="<?= base_url('appointment-details') ?>"> <button class="btn btn-sm btn-outline-primary mr-2">12:00
                                                                am</button></a>
    ...
    <script src="assetes/js/popper.min.js" integrity="sha384-ApNbgh9B+Y1QKtv3Rn7W3mgPxhU9K/ScQsAP7hUibX39j7fakFPskvXusvfa0b4Q" crossorigin="anonymous"></script>
    <script src="<?php echo base_url('public') ?>/assets/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
